---
title: "Debugging"
source_url: "https://docs.nvidia.com/cutlass/latest/media/docs/pythonDSL/cute_dsl_general/debugging.html"
...
You can enable that globally via the environment variable CUTE_DSL_LINEINFO=1. Alternative, you can use compilation options to enable that per kernel. Please refer to [JIT Compilation Options](dsl_jit_compilation_options.md) for more details.
...
For detailed examples of using these functions for debugging, please refer to the associated notebook referenced in [Educational Notebooks](notebooks.md).
