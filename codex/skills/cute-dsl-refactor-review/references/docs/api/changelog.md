---
title: "Changelog for CuTe DSL API changes"
source_url: "https://docs.nvidia.com/cutlass/latest/media/docs/pythonDSL/cute_dsl_api/changelog.html"
...
-   `cutlass.cute.compile` now supports compilation options. Refer to [JIT compilation options](../guide/dsl_jit_compilation_options.md) for more details.
