...
(define %my-home-config
  (home-environment
    (packages (append
               ;; Additional development tools for home
               (list
                ;; Apple fonts for UI consistency
                font-apple-sf-pro ;SF Pro Display/Text for UI
                font-apple-sf-mono ;SF Mono for terminals and code
                font-apple-sf-compact ;SF Compact for space-constrained UI
                font-apple-new-york ;New York serif for documents
                font-apple-sf-symbols ;SF Symbols for icons
   ...
   (append (list (service gnome-desktop-service-type)
                 (service gdm-service-type
                          (gdm-configuration (gnome-shell-assets
                                             ...
                                             (wayland? #t) ;Explicitly enable Wayland
                                             (debug? #f) ;Set to #t for troubleshooting
