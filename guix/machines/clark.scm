...
"))))
                 ...
                 (simple-service 'konrad shepherd-root-service-type
                                 (list (shepherd-service (requirement '(file-systems
                                                                        networking))
                                                         (provision '(konrad))
                                                         (documentation
                                                          "Runs the qemu VM specified in konrad.scm")
                                                                                                      ...
                                                                                                      (
                                                                                                       (cmd
                                                                                                        (list #$
                                                                                                         ...
                                                                                                         "-drive"
                                                                                                         "file=/data/konrad.qcow2,if=virtio,cache=writeback,werror=report"
                                                                                                         "-serial"
                                                                                                         "mon:stdio")))
